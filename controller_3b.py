...
class Tutorial (object):
  ...
  def _handle_PacketIn (self, event):
    ...
    if dpid not in self.connections:
        ...
        if dpid == 2:
            log.debug('Installing additional rules')
            #no communication to h12
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_dst = IPAddr('10.0.0.2'))
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
            """
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x800, nw_src = IPAddr('10.0.0.2'))
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
            """
            #secure sever h17
            #init_priority = 0x8001
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_dst = IPAddr('10.0.0.132'))
            msg.priority = 0x8001
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
            ...
            #only h18 can
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_src = IPAddr('20.0.0.2'), nw_dst = IPAddr('10.0.0.132'))
            msg.priority = 0x8002
            msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr("02:00:de:ad:be:22")))
            msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr("00:00:00:00:00:09")))
            msg.actions.append(of.ofp_action_output(port=2))
            self.connection.send(msg)
        
            #only h9,10,11 can ping
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_src = IPAddr('172.17.16.2'), nw_dst = IPAddr('10.0.0.132'), nw_proto=pkt.ipv4.ICMP_PROTOCOL)
            msg.priority = 0x8002
            msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr("02:00:de:ad:be:22")))
            msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr("00:00:00:00:00:09")))
            msg.actions.append(of.ofp_action_output(port=2))
            ...
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_src = IPAddr('172.17.16.3'), nw_dst = IPAddr('10.0.0.132'), nw_proto=pkt.ipv4.ICMP_PROTOCOL)
            msg.priority = 0x8002
            msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr("02:00:de:ad:be:22")))
            msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr("00:00:00:00:00:09")))
            msg.actions.append(of.ofp_action_output(port=2))
            ...
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, nw_src = IPAddr('172.17.16.4'), nw_dst = IPAddr('10.0.0.132'), nw_proto=pkt.ipv4.ICMP_PROTOCOL)
            msg.priority = 0x8002
            msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr("02:00:de:ad:be:22")))
            msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr("00:00:00:00:00:09")))
            msg.actions.append(of.ofp_action_output(port=2))
        ...
        if dpid == 5:
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, in_port = 2)
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
        if dpid == 6:
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, in_port = 2, nw_dst = IPAddr('10.0.0.132'))
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
            
            msg = of.ofp_flow_mod()
            msg.match = of.ofp_match(dl_type=0x0800, in_port = 3, nw_dst = IPAddr('10.0.0.132'))
            msg.actions.append(of.ofp_action_output(port=of.OFPP_NONE))
            self.connection.send(msg)
